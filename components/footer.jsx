...
export default function Footer() {
  return (
    <footer className="bg-biscuit-700 text-cream py-12">
      <div className="container mx-auto px-6 grid md:grid-cols-3 gap-6">
        <div>
          <h4 className="font-bold text-lg">3SK Cookies</h4>
          <p className="mt-2 text-sm">Small-batch oat biscuits with premium ingredients. Built on quality and hygiene.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <form className="mt-3 flex gap-2">
            <input className="rounded-md px-3 py-2 text-biscuit-700" placeholder="Your email" />
            <button className="bg-chocolate px-4 py-2 rounded-md text-cream">Join</button>
          </form>
        </div>
      </div>

      <div className="mt-8 border-t border-biscuit-500 pt-6 text-center text-sm">
